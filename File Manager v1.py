...
# Function to list directories with an option for search
def listDirectories():
    print("Listing directories and files:")
    listdir = os.listdir(os.getcwd())
    for x in listdir:
        print(x)
    print("\nType 'searchManager' to search for files/folders.")
    print("Type 'exitManager' to go back to the main menu.")

# Function to search for files or folders within the current directory and its subdirectories
def search():
    query = input("Enter the name of the file or folder to search for: ")
    ...
    def search_recursive(directory):
        ...
        for item in os.listdir(directory):
            ...
            if os.path.isfile(item_path) and query.lower() in item.lower():
                ...
                if query.lower() in item.lower():
                    ...
                    found = True
                found |= search_recursive(item_path)
        return found

    print("Search results:")
    if not search_recursive(os.getcwd()):
        print("No matching files or folders found.")

while True:
    print("1. Open files/folders")
    print("2. Rename")
    print("3. Move and Paste")
    print("4. Copy and Paste")
    print("5. Delete")
    print("6. Search")
    print("7. Exit\n")
